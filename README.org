* SQLingvo
  ...
  libraries. This library is designed to be used with [[http://www.postgresql.org/][PostgreSQL]]. If
  you are not using vendor specific features you might be lucky and be
